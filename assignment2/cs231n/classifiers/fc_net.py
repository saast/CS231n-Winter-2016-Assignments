...
class TwoLayerNet(object):
    ...
    def __init__(self, input_dim=3*32*32, hidden_dim=100, num_classes=10,
        ...
        # self.params, with first layer weights and biases using the keys 'W1'#
        # and 'b1' and second layer weights and biases using the keys 'W2' and#
        # 'b2'.                                                               #
        #######################################################################
...
#        affine - relu - affine - softmax.
        out, cache_af_1 = affine_forward(X, self.params['W1'],
                                         self.params['b1'])
        out, cache_relu = relu_forward(out)
        out, cache_af_2 = affine_forward(out, self.params['W2'],
                                         self.params['b2'])
        scores = out
...
#        print 'input_dim', input_dim
        ...
        # in the self.params dictionary. Store weights and biases for the     #
        # first layer in W1 and b1; for the second layer use W2 and b2, etc.  #
...
#        print 'b', str(L), self.params['b' + str(L)].shape
        ...
        if self.use_batchnorm:
            self.bn_params = [
                {'mode': 'train'} for i in xrange(self.num_layers - 1)]
    ...
    def loss(self, X, y=None):
        ...
        # normalization layer, pass self.bn_params[1] to the forward pass for #
