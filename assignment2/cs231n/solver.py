...
class Solver(object):
    ...
    - model.loss(X, y) must be a function that computes training-time loss and
        ...
        - y: Array of labels, of shape (N,) giving labels for X where y[i] is
            the label for X[i].

        Returns:
        If y is None, run a test-time forward pass and return:
        - scores: Array of shape (N, C) giving classification scores for X
    ...
    def __init__(self, model, data, **kwargs):
        ...
        - data: A dictionary of training and validation data with the
          following:
            ...
            'y_train': Array of shape (N_train,) giving labels for training
                images
            'y_val': Array of shape (N_val,) giving labels for validation
                images
        ...
        - optim_config: A dictionary containing hyperparameters that will be
            passed to the chosen update rule. Each update rule requires
            different hyperparameters (see optim.py) but all update rules
            require a 'learning_rate' parameter so that should always be
            present.
