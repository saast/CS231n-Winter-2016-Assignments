...
#    print dout.shape, w.T.shape, x.shape
...
def batchnorm_forward(x, gamma, beta, bn_param):
    ...
    if mode == 'train':
        ...
        # then scale and shift the normalized data using gamma and beta. Store#
...
def dropout_forward(x, dropout_param):
    ...
    if mode == 'train':
        ...
        # dropout. Store the dropout mask in the mask variable.               #
        #######################################################################
        pass
        #######################################################################
        #                            END OF YOUR CODE                         #
